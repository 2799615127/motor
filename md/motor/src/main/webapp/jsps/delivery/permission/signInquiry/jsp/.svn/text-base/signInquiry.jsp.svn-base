...
<script type="text/javascript" 
	src="${pageContext.request.contextPath }/jsps/delivery/permission/signInquiry/js/signInquiry.js">
</script>
</head>
<body>
	<div class="panel-body" style="padding-bottom: 0px;">
		...
		<div id="toolbar" class="btn-group">
			...
			<button id="btn_edit" type="button" class="btn btn-default"
				data-toggle="modal">
				<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>返单统计
			</button>
